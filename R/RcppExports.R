...
buildBedpeHiC <- function(validPairs, bedpefile, bedtoolsgenome, readlength = 100L) {
    invisible(.Call('mango_buildBedpeHiC', PACKAGE = 'mango', validPairs, bedpefile, bedtoolsgenome, readlength))
}
